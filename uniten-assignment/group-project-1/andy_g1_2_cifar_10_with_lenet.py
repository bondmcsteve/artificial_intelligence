# -*- coding: utf-8 -*-
"""Andy - G1.2 CIFAR-10 with LeNet

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DsE3syrg2kb9_NAoCwGBQm3sGqvIvp-s

# CIFAR-10 with MLP and LeNet
...
model = keras.Sequential(
    [
      ...
      #conv
      layers.Conv2D(64, kernel_size=11, strides=4, activation='relu', padding='same'), #C3
      #pool
